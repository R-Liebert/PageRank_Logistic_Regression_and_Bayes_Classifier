...
label_df = PR_df = pd.read_csv('pred_label.csv', skiprows=1, sep=',', names=['index', 'label'])
labels = label_df['label'].to_numpy(dtype=int)
...
Secret_message = get_msg_for_labels(labels)
